...
class FruitCultivation(models.Model):
    _name = 'fruit.cultivation'
    _description = 'Fruit Cultivation Form'
    ...
    treatment_id = fields.Many2one(
        'fruit.treatment', string='Treatment Product', ondelete='restrict')
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        res = super(FruitCultivation, self).fields_view_get(
